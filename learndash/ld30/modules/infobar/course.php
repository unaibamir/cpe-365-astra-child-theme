    ...
    <div class="ld-course-status ld-course-status-not-enrolled">
        ...
        do_action( 'learndash-course-infobar-noaccess-status-before', get_post_type(), $course_id, $user_id ); ?>
         ...
         <div class="ld-course-status-segment ld-course-status-seg-price">
             ...
             <span class="ld-course-status-label"><?php echo __( 'Price to Purchase <br>Course Individually', 'learndash' ); ?></span>
                    ...
                    switch($course_pricing['type']) {
                        ...
                        case('subscribe'):
                            ...
                            if( apply_filters( 'learndash_login_modal', true, $course_id, $user_id ) && !is_user_logged_in() ):
								...
								//echo '<a class="ld-login-text btn-join" href="' . esc_attr( $login_url ) . '">' . esc_html__( 'Login', 'learndash' ) . '</a></span>';
                            endif;
                            break;
                        case('closed'):
